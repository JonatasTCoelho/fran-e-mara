  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-50 w-full flex flex-col shadow-xl">
        {/* 1. Top Alert Block */}
        <div className="alert-bar w-full py-1.5 sm:py-2 px-2 sm:px-3 text-center relative z-10 shadow-[0_4px_20px_rgba(255,0,255,0.2)]">
          <p className="font-label-caps text-[10px] sm:text-[12px] md:text-label-caps text-white font-bold flex items-center justify-center gap-1 sm:gap-2">
            <span className="material-symbols-outlined text-[14px] sm:text-[18px] shrink-0">warning</span>
            <span className="leading-tight">ÚLTIMA CHANCE: Desconto encerra em:</span>
            <span className="bg-black/40 px-1.5 sm:px-2 py-0.5 rounded border border-white/20 font-mono text-[11px] sm:text-[16px] text-vc-gold tracking-widest tabular-nums shrink-0">
              {formatTime(timeLeft)}
            </span>
          </p>
        </div>
        ...
        <div className="w-full glass-nav border-b border-white/5">
          <div className="flex justify-between items-center px-3 sm:px-gutter py-2.5 sm:py-4 max-w-container-max-width mx-auto">
            <a href="https://pay.kiwify.com.br/p3v2VJS" target="_blank" rel="noopener noreferrer" className="flex items-center group cursor-pointer">
              <img 
                ...
                className="h-7 sm:h-11 md:h-14 w-auto object-contain transition-transform duration-300 group-hover:scale-105"
              />
            </a>
      ...
      <div className="w-full overflow-x-hidden">
        <main className="flex-grow">
          ...
          <section className="py-6 sm:py-10 md:py-16 px-4 sm:px-gutter max-w-container-max-width mx-auto flex flex-col items-center text-center relative">
            ...
            <div className="relative z-10 inline-flex items-center gap-2 sm:gap-2.5 px-3.5 sm:px-6 py-1.5 sm:py-2.5 rounded-full border border-vc-magenta/40 bg-vc-magenta/5 backdrop-blur-sm mb-4 sm:mb-6 md:mb-10 shadow-[0_0_15px_rgba(255,0,255,0.1)]">
              <span className="w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full bg-vc-magenta animate-pulse shadow-[0_0_10px_#FF00FF]"></span>
              <span className="font-label-caps text-[10px] sm:text-label-caps text-vc-magenta tracking-widest font-bold">MÉTODO VALIDADO</span>
            </div>
            <h1 className="relative z-10 font-display-lg text-[24px] sm:text-[36px] md:text-display-lg text-white mb-3 sm:mb-6 max-w-[1000px] leading-[1.25] sm:leading-[1.2] md:leading-[1.1]">
            ...
            <p className="relative z-10 font-body-lg text-[13px] sm:text-base md:text-body-lg text-white/70 mb-5 sm:mb-8 max-w-3xl leading-relaxed">
            ...
            {/* VSL Video */}
            <div className="relative z-10 w-full max-w-3xl mx-auto mb-6 sm:mb-8 rounded-xl sm:rounded-2xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5),0_0_40px_rgba(212,175,55,0.1)] transition-all duration-500 hover:shadow-[0_20px_50px_rgba(0,0,0,0.5),0_0_60px_rgba(255,0,255,0.15)] border border-white/10 hover:border-vc-magenta/30">
              <iframe 
            ...
            <div className="animate-fade-in-up w-full" style={{ animationDelay: '0.2s' }}>
              ...
              <section className="py-10 md:py-24 bg-gradient-to-b from-black via-[#050505] to-black relative border-y border-white/5">
                <div className="px-4 sm:px-gutter max-w-container-max-width mx-auto relative z-10">
                  ...
                  <div className="text-center bg-[#0a0a0a] border border-white/10 rounded-xl sm:rounded-2xl p-4 sm:p-8 max-w-3xl mx-auto shadow-2xl relative reveal reveal-delay-2">
                    <div className="absolute -top-10 -right-10 w-40 h-40 bg-red-500/10 blur-[50px] rounded-full pointer-events-none"></div>
                    <p className="font-headline-lg text-[16px] sm:text-[22px] md:text-[26px] leading-snug text-white/90">
              ...
              <section className="py-8 md:pt-8 md:pb-24 bg-black relative border-b border-white/5">
                ...
                <div className="px-4 sm:px-gutter max-w-container-max-width mx-auto relative z-10 flex flex-col gap-6 md:gap-10">
                  
                  {/* O Inimigo */}
                  <div className="flex flex-col md:flex-row items-center gap-4 md:gap-12">
                    <div className="flex-1 text-left reveal">
                      <span className="font-label-caps text-[11px] sm:text-label-caps text-red-500 mb-1 sm:mb-2 block tracking-widest uppercase font-bold">O Inimigo</span>
                      <h2 className="font-headline-lg text-[20px] sm:text-[28px] md:text-[36px] text-white mb-2 sm:mb-4 leading-[1.2]">
                      ...
                      <p className="font-body-lg text-[13px] sm:text-base md:text-body-lg text-white/70 leading-relaxed mb-2 sm:mb-4">
                    ...
                    <div className="flex-1 w-full flex justify-center">
                       <div className="w-full max-w-md bg-[#0a0a0a] border border-white/10 rounded-xl sm:rounded-3xl p-4 sm:p-8 relative shadow-2xl">
                          <div className="inline-flex items-center justify-center w-10 h-10 sm:w-20 sm:h-20 rounded-full bg-white/5 border border-white/10 mb-2.5 sm:mb-6">
                            <span className="material-symbols-outlined text-white/50 text-xl sm:text-4xl">visibility_off</span>
                          </div>
                          <p className="font-headline-md text-[13px] sm:text-xl leading-snug text-white/90 italic">
                  ...
                  <div className="flex flex-col md:flex-row-reverse items-center gap-4 md:gap-12">
                    <div className="flex-1 text-left reveal">
                      <span className="font-label-caps text-[11px] sm:text-label-caps text-vc-gold mb-1 sm:mb-2 block tracking-widest uppercase font-bold">A Solução</span>
                      <h2 className="font-headline-lg text-[20px] sm:text-[28px] md:text-[36px] text-white mb-2 sm:mb-4 leading-[1.2]">
                        Conheça o Método Vendas Conectadas.
                      </h2>
                      <p className="font-body-lg text-[13px] sm:text-base md:text-body-lg text-white/70 leading-relaxed mb-2 sm:mb-4">
                        <span className="md:hidden">Marketing e vendas alinhados para multiplicar seu faturamento.</span>
                    ...
                    <div className="flex-1 w-full flex justify-center">
                       <div className="w-full max-w-md bg-vc-magenta/5 border border-vc-magenta/20 rounded-xl sm:rounded-3xl p-4 sm:p-8 relative shadow-[0_20px_50px_rgba(255,0,255,0.1)]">
                          <div className="inline-flex items-center justify-center w-10 h-10 sm:w-20 sm:h-20 rounded-full bg-vc-magenta/20 border border-vc-magenta/30 mb-2.5 sm:mb-6">
                            <span className="material-symbols-outlined text-vc-magenta text-xl sm:text-4xl">rocket_launch</span>
                          </div>
                          <p className="font-headline-md text-[13px] sm:text-xl leading-snug text-white/90 italic font-bold">
              ...
              <section className="py-10 md:py-24 md:min-h-screen flex flex-col justify-center px-4 sm:px-gutter bg-gradient-to-b from-black via-[#050505] to-black relative border-b border-white/5">
                <div className="max-w-container-max-width mx-auto relative z-10 w-full">
                  <div className="text-center mb-6 md:mb-16 reveal">
                    <h2 className="font-display-lg-mobile md:font-display-lg text-[20px] sm:text-[28px] md:text-[36px] text-white mb-2">
                  ...
                  <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-2.5 md:gap-6 relative reveal reveal-delay-1">
                    <div className="absolute left-[19px] top-3 bottom-3 w-0.5 bg-gradient-to-b from-vc-magenta via-vc-gold to-vc-magenta opacity-30 md:hidden"></div>
                    ...
                    {[
                      ...
                      <div key={idx} className="flex flex-row items-center gap-3 bg-[#0a0a0a] border border-white/10 p-3 md:p-6 rounded-lg md:rounded-2xl relative z-10 hover:border-vc-gold/30 transition-colors">
                        <div className="w-8 h-8 md:w-14 md:h-14 rounded-full bg-vc-magenta/20 border border-vc-magenta/40 flex items-center justify-center shrink-0">
                          <span className="font-bold text-vc-magenta text-[13px] md:text-xl">{item.step}</span>
                        </div>
                        <div>
                          <h3 className="text-white font-headline-md text-[13px] sm:text-base md:text-xl leading-tight">{item.title}</h3>
                        </div>
                      </div>
                    ))}
                  </div>
              ...
              <section className="py-10 md:py-20 px-4 sm:px-gutter relative" id="metodo">
                ...
                <div className="max-w-container-max-width mx-auto relative z-10">
                  <div className="text-center mb-6 md:mb-10 reveal">
                    <h2 className="font-display-lg-mobile md:font-display-lg text-[20px] sm:text-[28px] md:text-[40px] text-white mb-2 sm:mb-4">O QUE VOCÊ VAI APRENDER</h2>
                    <p className="font-body-lg text-white/70 max-w-2xl mx-auto text-[13px] sm:text-[15px] md:text-base">
                      Os pilares do Método Vendas Conectadas
                    </p>
                  </div>
      
                  <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-2.5 md:gap-6 reveal reveal-delay-1">
                    {/* Feature 1 */}
                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl sm:rounded-2xl p-3 sm:p-5 hover:bg-white/10 transition-colors group">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 bg-vc-magenta/20 rounded-lg sm:rounded-xl flex items-center justify-center mb-2 sm:mb-4 group-hover:scale-110 transition-transform">
                        <span className="material-symbols-outlined text-vc-magenta text-base sm:text-xl">verified</span>
                      </div>
                      <h3 className="font-headline-md text-[12px] sm:text-[17px] text-white mb-1 sm:mb-2 leading-snug">Posicionamento Estratégico</h3>
                      <p className="text-white/70 text-[11px] sm:text-[14px] leading-relaxed">Presença digital que desperta confiança.</p>
                    </div>
                    {/* Feature 2 */}
                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl sm:rounded-2xl p-3 sm:p-5 hover:bg-white/10 transition-colors group">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 bg-vc-magenta/20 rounded-lg sm:rounded-xl flex items-center justify-center mb-2 sm:mb-4 group-hover:scale-110 transition-transform">
                        <span className="material-symbols-outlined text-vc-magenta text-base sm:text-xl">person_search</span>
                      </div>
                      <h3 className="font-headline-md text-[12px] sm:text-[17px] text-white mb-1 sm:mb-2 leading-snug">Público Ideal</h3>
                      <p className="text-white/70 text-[11px] sm:text-[14px] leading-relaxed">Descubra quem compra de você.</p>
                    </div>
                    {/* Feature 3 */}
                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl sm:rounded-2xl p-3 sm:p-5 hover:bg-white/10 transition-colors group">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 bg-vc-magenta/20 rounded-lg sm:rounded-xl flex items-center justify-center mb-2 sm:mb-4 group-hover:scale-110 transition-transform">
                        <span className="material-symbols-outlined text-vc-magenta text-base sm:text-xl">campaign</span>
                      </div>
                      <h3 className="font-headline-md text-[12px] sm:text-[17px] text-white mb-1 sm:mb-2 leading-snug">Anúncios Inteligentes</h3>
                      <p className="text-white/70 text-[11px] sm:text-[14px] leading-relaxed">Conteúdos para os clientes certos.</p>
                    </div>
                    {/* Feature 4 */}
                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl sm:rounded-2xl p-3 sm:p-5 hover:bg-white/10 transition-colors group">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 bg-vc-magenta/20 rounded-lg sm:rounded-xl flex items-center justify-center mb-2 sm:mb-4 group-hover:scale-110 transition-transform">
                        <span className="material-symbols-outlined text-vc-magenta text-base sm:text-xl">bar_chart</span>
                      </div>
                      <h3 className="font-headline-md text-[12px] sm:text-[17px] text-white mb-1 sm:mb-2 leading-snug">Leitura de Métricas</h3>
                      <p className="text-white/70 text-[11px] sm:text-[14px] leading-relaxed">Decisões baseadas em números.</p>
                    </div>
                    {/* Feature 5 */}
                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl sm:rounded-2xl p-3 sm:p-5 hover:bg-white/10 transition-colors group">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 bg-vc-magenta/20 rounded-lg sm:rounded-xl flex items-center justify-center mb-2 sm:mb-4 group-hover:scale-110 transition-transform">
                        <span className="material-symbols-outlined text-vc-magenta text-base sm:text-xl">forum</span>
                      </div>
                      <h3 className="font-headline-md text-[12px] sm:text-[17px] text-white mb-1 sm:mb-2 leading-snug">Prospecção Estratégica</h3>
                      <p className="text-white/70 text-[11px] sm:text-[14px] leading-relaxed">Clientes no WhatsApp de forma natural.</p>
                    </div>
                    {/* Feature 6 */}
                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl sm:rounded-2xl p-3 sm:p-5 hover:bg-white/10 transition-colors group">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 bg-vc-magenta/20 rounded-lg sm:rounded-xl flex items-center justify-center mb-2 sm:mb-4 group-hover:scale-110 transition-transform">
                        <span className="material-symbols-outlined text-vc-magenta text-base sm:text-xl">handshake</span>
                      </div>
                      <h3 className="font-headline-md text-[12px] sm:text-[17px] text-white mb-1 sm:mb-2 leading-snug">Comunicação Persuasiva</h3>
                      <p className="text-white/70 text-[11px] sm:text-[14px] leading-relaxed">Conversas que viram vendas.</p>
                    </div>
                  </div>
              ...
              <section className="py-10 md:py-24 bg-black relative border-b border-white/5">
                ...
                <div className="px-4 sm:px-gutter max-w-container-max-width mx-auto relative z-10">
                  <div className="text-center mb-6 md:mb-16 reveal">
                    <h2 className="font-headline-lg text-[20px] sm:text-[28px] md:text-headline-lg text-white mb-2 sm:mb-4">
                    ...
                    <p className="font-body-lg text-white/70 text-[13px] sm:text-base md:text-lg">Você <span className="text-red-500 font-bold">NÃO precisa:</span></p>
                  </div>
                  
                  <div className="flex flex-wrap justify-center gap-2 sm:gap-4 mb-6 md:mb-12 max-w-4xl mx-auto reveal reveal-delay-1">
                    {[
                      'Ser influenciadora.', 'Ter milhares de seguidores.', 'Entender de marketing.',
                      'Fazer vídeos todos os dias.', 'Investir muito dinheiro.'
                    ].map((item, idx) => (
                      <div key={idx} className="flex items-center gap-1.5 sm:gap-3 bg-[#0a0a0a] border border-white/10 py-2 sm:py-3 px-2.5 sm:px-6 rounded-full hover:border-red-500/30 transition-colors">
                        <span className="material-symbols-outlined text-red-500 text-sm sm:text-xl shrink-0">close</span>
                        <span className="text-white/80 font-body-md text-[12px] sm:text-base">{item}</span>
                      </div>
                    ))}
                  </div>
                  
                  <div className="text-center reveal reveal-delay-2">
                    <p className="font-headline-md text-base sm:text-2xl text-vc-gold inline-block border-b-2 border-vc-gold/30 pb-1 sm:pb-2">
              ...
              {/* 9. QUEM SOMOS */}
              <section className="pt-10 md:pt-24 pb-12 md:pb-40 bg-gradient-to-b from-black via-[#050505] to-black relative border-b border-white/5">
                ...
                <div className="px-4 sm:px-gutter max-w-5xl mx-auto relative z-10">
                  <div className="grid grid-cols-2 md:grid-cols-2 gap-2.5 md:gap-8 mb-6 md:mb-12 reveal">
                    
                    <div className="bg-[#0a0a0a] border border-white/10 rounded-xl sm:rounded-3xl p-3.5 md:p-8 flex flex-col items-center text-center relative overflow-hidden group hover:border-vc-magenta/30 transition-colors">
                      ...
                      <div className="w-14 h-14 sm:w-24 sm:h-24 rounded-full bg-white/10 border-2 border-vc-magenta mb-2.5 sm:mb-6 flex items-center justify-center overflow-hidden">
                        <img src="/fran.jpg" alt="Fran Martins" className="w-full h-full object-cover" />
                      </div>
                      <h3 className="text-white font-headline-lg text-[14px] sm:text-2xl mb-0.5 sm:mb-2">Fran Martins</h3>
                      <p className="text-vc-magenta font-label-caps text-[9px] sm:text-sm tracking-widest uppercase mb-1.5 sm:mb-4 font-bold leading-tight">Especialista em Posicionamento</p>
                      <p className="text-white/70 font-body-md text-[11px] sm:text-base leading-relaxed">
                        <span className="md:hidden">Os clientes certos encontram seu negócio.</span>
                        <span className="hidden md:inline">Ensina como fazer as pessoas certas encontrarem seu negócio.</span>
                      </p>
                    </div>

                    <div className="bg-[#0a0a0a] border border-white/10 rounded-xl sm:rounded-3xl p-3.5 md:p-8 flex flex-col items-center text-center relative overflow-hidden group hover:border-vc-gold/30 transition-colors">
                      ...
                      <div className="w-14 h-14 sm:w-24 sm:h-24 rounded-full bg-white/10 border-2 border-vc-gold mb-2.5 sm:mb-6 flex items-center justify-center overflow-hidden">
                        <img src="/mara.png" alt="Mara Camargo" className="w-full h-full object-cover" />
                      </div>
                      <h3 className="text-white font-headline-lg text-[14px] sm:text-2xl mb-0.5 sm:mb-2">Mara Camargo</h3>
                      <p className="text-vc-gold font-label-caps text-[9px] sm:text-sm tracking-widest uppercase mb-1.5 sm:mb-4 font-bold leading-tight">Especialista em Vendas</p>
                      <p className="text-white/70 font-body-md text-[11px] sm:text-base leading-relaxed">
                        <span className="md:hidden">Interesse vira faturamento real.</span>
              ...
              {/* 10. PROVAS */}
              <section className="py-8 md:py-20 px-4 sm:px-gutter max-w-container-max-width mx-auto relative" id="resultados">
                <div className="text-center mb-5 sm:mb-10 reveal">
                  <h2 className="font-display-lg-mobile md:font-display-lg text-[20px] sm:text-[28px] md:text-[38px] text-white mb-2 sm:mb-4">
                    <span className="md:hidden">Depoimentos de Alunos</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-6 reveal reveal-delay-1">
                  ...
                  <div className="bg-[#0a0a0a] border border-white/10 rounded-xl sm:rounded-2xl p-4 sm:p-8 flex flex-col items-center text-center shadow-lg hover:border-vc-gold/30 transition-colors">
                    <div className="w-11 h-11 sm:w-16 sm:h-16 bg-white/10 rounded-full mb-2.5 sm:mb-3 overflow-hidden border-2 border-vc-gold flex items-center justify-center shrink-0">
                    ...
                    <h3 className="text-white font-bold text-[14px] sm:text-lg mb-0.5 sm:mb-1">Ana Clara</h3>
                    <p className="text-vc-gold font-bold text-[11px] sm:text-sm mb-2 sm:mb-4">+ R$ 15.000 em 30 dias</p>
                    <p className="text-white/70 text-[12px] sm:text-sm leading-relaxed italic">&quot;Eu não sabia nada de tráfego. Depois do Vendas Conectadas, minhas campanhas dão ROI de 5x toda semana!&quot;</p>
                  </div>
                  ...
                  <div className="bg-[#0a0a0a] border border-white/10 rounded-xl sm:rounded-2xl p-4 sm:p-8 flex flex-col items-center text-center shadow-lg hover:border-vc-gold/30 transition-colors">
                    ...
                    <h3 className="text-white font-bold text-[14px] sm:text-lg mb-0.5 sm:mb-1">Juliana Santos</h3>
                    <p className="text-vc-gold font-bold text-[11px] sm:text-sm mb-2 sm:mb-4">Clientes diários no WhatsApp</p>
                    <p className="text-white/70 text-[12px] sm:text-sm leading-relaxed italic">&quot;Com a estratégia do Vendas Conectadas, fecho novos clientes quase diariamente direto no WhatsApp.&quot;</p>
                  </div>
                  ...
                  <div className="bg-[#0a0a0a] border border-white/10 rounded-xl sm:rounded-2xl p-4 sm:p-8 flex flex-col items-center text-center shadow-lg hover:border-vc-gold/30 transition-colors">
                    ...
                    <h3 className="text-white font-bold text-[14px] sm:text-lg mb-0.5 sm:mb-1">Marcos Silva</h3>
                    <p className="text-vc-gold font-bold text-[11px] sm:text-sm mb-2 sm:mb-4">Dobrou o faturamento</p>
                    <p className="text-white/70 text-[12px] sm:text-sm leading-relaxed italic">&quot;Apliquei o script de Direct e hoje tenho agenda lotada para os próximos 2 meses.&quot;</p>
                  </div>
              ...
              <section className="py-8 md:py-12 px-4 sm:px-gutter relative" id="oferta">
                ...
                <div className="max-w-5xl mx-auto flex flex-col items-center">
                  ...
                  <div className="w-full max-w-2xl mx-auto mb-3 sm:mb-4 rounded-xl sm:rounded-2xl overflow-hidden border border-white/10 shadow-[0_15px_40px_rgba(255,0,255,0.15)] reveal reveal-delay-1">
                    <img 
                  ...
                  <div className="max-w-2xl w-full mx-auto bg-black border border-white/10 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 text-center relative overflow-hidden shadow-[0_30px_100px_rgba(255,0,255,0.15)] group reveal-scale reveal-delay-1">
                    ...
                    <div className="relative z-10">
                      <h2 className="font-display-lg text-[20px] sm:text-[26px] md:text-[30px] text-white mb-1 leading-none">Acesso Completo</h2>
                    <div className="inline-flex items-center gap-1.5 sm:gap-2 bg-vc-magenta/20 border border-vc-magenta/40 px-2.5 sm:px-3 py-1 rounded-full mt-1 mb-3">
                      <span className="material-symbols-outlined text-[13px] sm:text-[15px] text-vc-magenta">timer</span>
                      <span className="text-[10px] sm:text-[13px] font-bold text-white/90 uppercase tracking-widest">
                        Oferta expira em <span className="font-mono text-vc-gold tabular-nums ml-0.5 sm:ml-1">{formatTime(timeLeft)}</span>
                      </span>
                    </div>
                    <div className="mb-3 sm:mb-4 w-full max-w-lg mx-auto grid grid-cols-2 md:grid-cols-2 gap-x-3 sm:gap-x-4 gap-y-1 sm:gap-y-1.5 text-left">
                      {[
                    ...
                    <div className="my-2 relative">
                      ...
                      <div className="bg-black inline-block px-3 relative z-10">
                        <div className="flex items-center justify-center gap-2 mb-0.5">
                          <p className="text-white/50 line-through text-[11px] sm:text-xs font-light">De R$ 497</p>
                          <p className="font-bold text-white/90 text-[11px] sm:text-xs font-label-caps tracking-widest uppercase">por apenas</p>
                        </div>
                        <div className="font-display-lg text-[26px] sm:text-[34px] md:text-[42px] font-bold text-transparent bg-clip-text bg-gradient-to-b from-vc-gold to-[#b38f22] leading-none my-1 drop-shadow-[0_0_15px_rgba(212,175,55,0.2)]">
                          12x R$ 20,37
                        </div>
                        <p className="text-white/60 text-[11px] sm:text-xs">ou R$ 197 à vista.</p>
                      </div>
                    </div>
                    <a href="https://pay.kiwify.com.br/p3v2VJS" target="_blank" rel="noopener noreferrer" className="w-full md:w-[85%] mx-auto text-center bg-vc-magenta text-white font-headline-md text-[13px] sm:text-[16px] md:text-[18px] py-3 px-5 sm:px-6 rounded-xl transition-all duration-300 glow-magenta-hover font-bold shadow-[0_10px_40px_rgba(255,0,255,0.4)] mb-3 uppercase tracking-wide hover:-translate-y-0.5 block">
                      QUERO CONHECER O MÉTODO
                    </a>
                    <div className="flex items-center justify-center gap-2 sm:gap-2.5 bg-white/5 backdrop-blur-md p-2.5 sm:p-3 rounded-xl border border-white/10 w-full hover:bg-white/10 transition-colors">
                      <span className="material-symbols-outlined text-vc-gold text-xl sm:text-2xl shrink-0">verified_user</span>
                      <div className="text-left">
                        <p className="font-bold text-white font-headline-md text-[12px] sm:text-[14px] mb-0.5 leading-tight">Garantia Incondicional de 7 Dias.</p>
                        <p className="text-white/70 font-body-md text-[10px] sm:text-xs">Seu risco é absolutamente zero.</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <section className="pt-6 md:pt-12 pb-10 md:pb-20 px-4 sm:px-gutter max-w-4xl mx-auto relative border-b border-white/5" id="faq">
                ...
                <div className="space-y-2 sm:space-y-3.5 relative z-10 reveal reveal-delay-1">
                  {[
                    ...
                    <details key={idx} className="group bg-[#0a0a0a] rounded-lg sm:rounded-xl border border-white/10 open:border-vc-gold/40 transition-all duration-300 hover:border-white/20 shadow-lg">
                      <summary className="flex justify-between items-center font-bold cursor-pointer list-none p-3 md:p-5 text-white font-headline-md text-[13px] md:text-lg select-none">
                        <span className="flex items-center gap-2 sm:gap-2.5">
                          <span className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-vc-gold rounded-full opacity-50 group-open:opacity-100 transition-opacity shrink-0"></span> 
                          {faq.q}
                        </span>
                        <span className="transition-transform duration-300 group-open:rotate-180 text-vc-gold/70 group-open:text-vc-gold shrink-0 ml-2">
                          <span className="material-symbols-outlined text-lg md:text-2xl">expand_more</span>
                        </span>
                      </summary>
                      <div className="text-white/70 p-3 pt-0 md:p-5 md:pt-0 font-body-lg text-[12px] md:text-base pl-6 md:pl-10 leading-relaxed border-t border-white/5 mt-1.5 sm:mt-2">
                        {faq.a}
                      </div>
                    </details>
                  ))}
              ...
              <section className="py-10 md:py-28 px-4 sm:px-gutter bg-gradient-to-b from-black via-[#080808] to-black relative overflow-hidden">
                ...
                <div className="max-w-xl mx-auto bg-[#0a0a0a] p-5 sm:p-8 md:p-12 rounded-xl sm:rounded-3xl border border-white/10 shadow-[0_20px_50px_rgba(255,0,255,0.15)] relative z-10 reveal">
                  <div className="text-center mb-5 sm:mb-6">
                    <span className="font-label-caps text-[10px] sm:text-label-caps text-vc-gold mb-1 sm:mb-2 inline-block tracking-widest uppercase font-bold">GARANTA SUA VAGA</span>
                    <h3 className="font-headline-lg text-lg sm:text-2xl md:text-3xl text-white mb-1 font-bold">Pronta para começar?</h3>
                    <p className="text-white/70 font-body-md text-[12px] sm:text-base">Preencha seus dados para acessar o método imediatamente.</p>
                  </div>
                  
                  <form className="flex flex-col gap-3 sm:gap-4" onSubmit={(e) => { e.preventDefault(); window.open('https://pay.kiwify.com.br/p3v2VJS', '_blank'); }}>
                    <div>
                      <input 
                        type="text" 
                        placeholder="Seu Nome Completo" 
                        required
                        className="w-full bg-white/5 border border-white/10 rounded-lg sm:rounded-xl px-4 sm:px-5 py-3 sm:py-4 text-white placeholder:text-white/30 focus:outline-none focus:border-vc-gold/50 transition-colors text-[13px] sm:text-base"
                      />
                    </div>
                    <div>
                      <input 
                    ...
                    <button type="submit" className="w-full bg-vc-magenta text-white font-headline-md text-[14px] sm:text-lg py-3.5 sm:py-5 rounded-lg sm:rounded-xl hover:bg-vc-magenta-hover transition-all duration-300 glow-magenta font-bold uppercase tracking-wide mt-1 sm:mt-2 shadow-lg hover:-translate-y-0.5 cursor-pointer">
        ...
        {showContent && (
          ...
          <footer className="w-full py-12 sm:py-20 bg-black border-t border-white/5 flex flex-col items-center gap-base px-4 sm:px-gutter relative z-10 pb-24 md:pb-20">
            <a href="https://pay.kiwify.com.br/p3v2VJS" target="_blank" rel="noopener noreferrer" className="inline-block cursor-pointer group">
              <img 
                src="/logo.png" 
                alt="Vendas Conectadas com Mara Camargo e Fran Martins" 
                className="h-8 sm:h-12 md:h-16 w-auto object-contain mb-4 sm:mb-6 opacity-90 group-hover:opacity-100 transition-opacity"
              />
            </a>
            ...
            <div className="flex flex-col items-center gap-1.5 sm:gap-2 text-center">
              <p className="text-white/40 font-body-md text-[12px] sm:text-sm md:text-body-md">
                © 2026 Vendas Conectadas. Todos os direitos reservados.
              </p>
              <p className="text-white/30 font-body-md text-[10px] sm:text-xs tracking-wider">
      ...
      {/* Sticky Mobile CTA */}
      {showContent && (
        <div className="fixed bottom-0 left-0 w-full p-3 sm:p-4 bg-black/90 backdrop-blur-md border-t border-white/10 z-[100] md:hidden flex justify-center shadow-[0_-10px_30px_rgba(255,0,255,0.15)] animate-[slideInUp_0.5s_ease-out]">
           <a href="https://pay.kiwify.com.br/p3v2VJS" target="_blank" rel="noopener noreferrer" className="w-full bg-vc-magenta text-white font-headline-md text-[16px] py-3.5 rounded-lg sm:rounded-xl text-center glow-magenta font-bold uppercase tracking-wide">
             Garantir Minha Vaga
           </a>
        </div>
      )}
      ...
      {showContent && (
        <a href="https://wa.me/5519999701829?text=Oi!%20Estou%20na%20página%20do%20Vendas%20Conectadas%20e%20tenho%20uma%20dúvida." target="_blank" rel="noopener noreferrer" className="fixed bottom-20 md:bottom-8 right-4 sm:right-6 z-[90] w-12 h-12 sm:w-14 sm:h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-[0_4px_20px_rgba(37,211,102,0.4)] hover:scale-110 transition-transform cursor-pointer">
      ...
      {showScrollTop && (
        <button 
          ...
          className="fixed bottom-20 md:bottom-8 left-4 sm:left-6 z-[90] w-10 h-10 sm:w-12 sm:h-12 bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/20 text-white rounded-full flex items-center justify-center shadow-[0_4px_20px_rgba(0,0,0,0.5)] transition-all duration-300 hover:-translate-y-1"
        >
